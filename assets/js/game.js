...
var startGame = function(){
    ...
    for(var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            //the parameter is set so when the function is called it will substitute these two numbers as min and max values
            //since the function is being hoisted so it re-assigns the value here
